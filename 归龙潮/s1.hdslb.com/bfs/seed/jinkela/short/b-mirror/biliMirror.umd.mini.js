!(function (e, t) {
        ...
        (function () {
          try {
            return window.KvSDK
              ...
              : Promise.resolve(
                  P("//s1.hdslb.com/bfs/seed/jinkela/kv-sdk/index.js", {
                    lib: "KvSDK",
                  })
                );
          } catch (e) {
  ...
  class A {
    ...
    getConfig() {
      return t(this, void 0, void 0, function* () {
        this._defaultConfigSDK = yield C(
          Object.assign(
            {
              appKey: L.SPMID,
              strict: 1,
        ...
        const { SPMID: e, GROUP: t, KEY: n, KEYTOP: r } = L,
          o = this.spmId || a,
        ...
        e !== o &&
          ...
          (this._configSDK = yield C(
            Object.assign(
              { appKey: o, strict: 1, reporter: { ignoreAppKeyNotFound: !0 } },
              this.kvOptions
            )
          )),
          (c = yield this.fetchWhiteListConfig(this._configSDK, `${t}.${n}`)));
        let l = O(i, c);
        return (
          (l = O(l, s)),
          new Promise((e) => {
  ...
  function j() {
    return k.options || (k.options = new A());
  }
  const x = r() ? j() : null;
  function M() {
  ...
  var $,
    ...
    X = function (e) {
      "hidden" === document.visibilityState &&
        Y > -1 &&
        ((Y = "visibilitychange" === e.type ? e.timeStamp : 0), Q());
    },
    z = function () {
          ...
          var r,
            ...
            i = function (e) {
              me(function () {
                e.forEach(pe);
                var t = (function () {
                  var e = Math.min(ue.length - 1, Math.floor((ce() - fe) / 50));
                  return ue[e];
                })();
                t &&
                  t.latency !== o.value &&
      ...
      createIndexedDB() {
        if (window.indexedDB)
          return new Promise((e, t) => {
            const n = indexedDB.open(_e, 1);
            (n.onupgradeneeded = (e) => {
              const t = e.target.result;
              t.objectStoreNames.contains(Te) ||
                t.createObjectStore(Te, { keyPath: Pe });
            }),
              (n.onsuccess = (t) => {
      ...
      add(e) {
        ...
        (n.onupgradeneeded = (e) => {
          ...
          (n.onsuccess = (n) => {
            ...
            if (!r.objectStoreNames.contains(Te)) return;
      ...
      getAll() {
        ...
        if (window.indexedDB)
          return new Promise((t, n) => {
            let r = [];
            const o = indexedDB.open(_e);
            (o.onsuccess = (o) => {
              const i = o.target.result;
              if (!i.objectStoreNames.contains(Te))
                return void n(`the store log not exists in the ${_e} dataBase`);
              const s = i.transaction(Te, "readonly").objectStore(Te);
              if (e)
  ...
  class Ve {
    ...
    handleDomClick(e) {
      ...
      t &&
        (Ye() && lt(Me.CLICK, "点击", { dom: t, url: location.href }),
        qe(xe.DOM) &&
          Ge.push({
            category: ke.CLICK,
            status: Ae.OK,
    ...
    handleScroll() {
      ...
      Ye() && lt(Me.SCROLL, "页面滚动", { top: e, url: location.href }),
        qe(xe.SCROLL) &&
          Ge.push({
            category: ke.SCROLL,
            status: Ae.OK,
    ...
    handleWhiteScreen() {
      Ye() && lt(Me.WHITE, "白屏错误", { url: location.href }),
        qe(xe.WHITE) &&
          Ge.push({
            category: ke.WHITE,
            status: Ae.ERROR,
  ...
  function et() {
    ...
    function u(e, t, n, r) {
      var i = t && t.prototype instanceof v ? t : v,
        ...
        a = new N(r || []);
      return o(s, "_invoke", { value: _(e, n, a) }), s;
    }
    function d(e, t, n) {
      try {
  ...
  function ft() {
    return t(this, void 0, void 0, function* () {
      try {
        ...
        if (!window.indexedDB) return;
        if (
          (Ce.deleteIndexedDB("MIRROR_TRACK"),
          (ot.logType = ct()),
          "none" === ot.logType)
        )
          return;
        "log" !== ot.logType &&
          (yield Ce.createIndexedDB(),
          (function () {
            const e = st("buvid3") || "-",
              t = st("DedeUserID") || "-";
  ...
  function Nt() {
    if (St.length && !_t) {
      _t = !0;
      const [e, t, n, r] = St.shift();
      if ("middleWare" === t) {
        if (Pt) return (_t = !1), xt(n, r), void Nt();
        e(!0).then((e) => {
          var t;
          (_t = !1), (Pt = e), pt !== (t = Pt) && (pt = t), Mt(n, r), Nt();
        });
      } else
        e().then(() => {
          (_t = !1), t && n && t(n, r || void 0), Nt();
        });
    }
  }
  const kt = (e) => {
      const t = Tt ? window[Tt] : window.__biliMirrorPbInstance__;
      e = Ht(e);
      const n = Ct(e);
    ...
    Lt = (e, t) => {
      ...
      const n = Ct(e),
        r = Tt ? window[Tt] : window.__biliMirrorPbInstance__,
        o = Object.assign(Object.assign(Object.assign({}, e.msg), It), {
          mirrorVersion: I,
          type: e.type || "custom",
        });
      null == r || r.tech(n, o);
    ...
    Mt = (e, t) => {
      ...
      (null == t ? void 0 : t.isBatch)
        ? ((e, t, n) => {
            ...
            e.msg,
            Object.assign({ type: "custom", mirrorVersion: I }, It)
          )
        : Pt.tech(
            n + (t.eventId || ".ERROR.errorReport"),
            Object.assign(
              Object.assign(
                { type: e.type || "custom", mirrorVersion: I },
                e.msg
              ),
              It
            )
    ...
    Dt = function () {
      ...
      try {
        return new Promise((t, n) => {
          if ((r() || n("not support in server"), e)) {
            const e = { feature: { tech: !0 }, autoPv: !1, batch: !1 };
            if (window.ReporterPb) {
              const n = new window.ReporterPb(Object.assign({}, e));
              t(n);
            } else
            ...
            if (f.isObject(window[e]) && Object.keys(window[e]).length)
              (Tt = e),
                ...
                t();
            else if (window.__biliMirrorPbInstance__) t();
            else {
              const e = O(
                {
                  feature: { tech: !0 },
                  extra: Object.assign(Object.assign({}, It), {
                    mirrorVersion: I,
                  }),
                },
                (null == x ? void 0 : x.pbOptions) || {}
              );
              window.ReporterPb
                ? ((window.__biliMirrorPbInstance__ = new window.ReporterPb(e)),
                  t())
                : N(Object.assign({}, e)).then((e) => {
                    (window.__biliMirrorPbInstance__ = e), t();
                  });
            }
          }
        });
        ...
        (i = /^(eval@)?(\[native code])?$/),
        {
          ...
          parseOpera9: function (e) {
            for (
              ...
              a &&
                o.push(
                  new n({ fileName: a[2], lineNumber: a[1], source: r[i] })
                );
            }
            return o;
          },
              ...
              const t = ((e) => {
                  ...
                  if (
                    ...
                    let o = Ut.parse(n ? e.error : e)[0],
                      { fileName: i, columnNumber: s, lineNumber: a } = o;
                    return {
                      type: "error",
                      time: l(),
                      message: e.message,
          ...
          try {
            ...
            const t = ((e) => {
                ...
                return {
                  ...
                  time: l(),
                  message:
                    ((a = e.reason.message || e.reason.stack),
                    f.isString(a)
                      ? a
                      : f.isUndefined(a)
                      ? "undefined"
  ...
  let Vt = null,
    Xt = null;
  const zt = "BILI_MIRROR_RESOURCE_TIME",
    Qt = [
      "xmlhttprequest",
      "fetch",
      "img",
  ...
  class en {
    ...
    destroy() {
      Xt && Xt.disconnect(), null == Vt || Vt.clear();
    }
    _getAllData() {
    ...
    _isCheckResource(e) {
      if (!Qt.includes(e.initiatorType)) return !1;
      if (!Object.keys(this.config).length) return !1;
      let t = !1;
      for (let n in this.config) {
        if (Zt[n].split(",").includes(e.initiatorType)) {
          if ("*" === this.config[n]) {
            t = !0;
            break;
          }
          ...
          if (Array.isArray(this.config[n]) && this.config[n].length)
            for (let r = 0; r < this.config[n].length; r++) {
              if (e.name.split("?")[0].match(this.config[n][r])) {
                t = !0;
                break;
              }
            }
    ...
    _computeResourceData_(e) {
      const t = e.name.split("?"),
        {
          ...
          redirectEnd: a = 0,
          domainLookupEnd: c = 0,
          domainLookupStart: l = 0,
          connectEnd: u = 0,
          connectStart: d = 0,
          secureConnectionStart: f = 0,
          responseStart: h = 0,
          requestStart: p = 0,
          responseEnd: m = 0,
        } = e;
      return {
        url: t[0],
        query: t[1] || "",
        duration: o.toFixed(2),
        size: n,
        type: r,
        protocol: i,
        redirectTime: Math.max(0, a - s),
        dnsTime: Math.max(0, c - l),
        sslTime: f > 0 ? Math.max(0, u - f) : 0,
        tcpTime: Math.max(0, u - d),
        requestTime: Math.max(0, h - p),
        responseTime: Math.max(0, m - h),
      };
    }
    _addResourceReportPool(e) {
      let t = JSON.parse(localStorage.getItem(zt) || "{}");
      const n = e.url;
      t[n] || (t[n] = Object.assign({}, e)),
        localStorage.setItem(zt, JSON.stringify(t));
    }
    _startReportInterval() {
      Vt ||
        ((Vt = new Be()),
        Vt.repeat(this._clearResourceReport, 18e4),
        c(i, "beforeunload", () => {
          this._clearResourceReport(), this._cleanUpReportPool();
        }));
    }
    _clearResourceReport() {
      try {
        let e = JSON.parse(localStorage.getItem(zt) || "{}");
        Object.keys(e).length &&
          jt({
            type: "performance",
            eventId: `${x.origin}.${x.module}.PERFORMANCE.RESOURCETIME`,
            msg: { resourceListInfo: Object.assign({}, e) },
          }),
          localStorage.setItem(zt, "");
      } catch (e) {}
    }
    _createObserver() {
  ...
  function tn(e) {
    if (r()) {
      if (
        ...
        c(i, "unhandledrejection", function (e) {
        ...
        try {
          !(function (e) {
            ...
            if (
              ...
              return;
            if (
              (null !== (c = null == i ? void 0 : i.innerWidth) && void 0 !== c
                ? c
                : 0) <= 10 ||
              ...
              return t(this, void 0, void 0, function* () {
                ...
                for (let e = 1; e <= 9; e++) {
                  const n = (i.innerWidth * e) / 10,
                    ...
                    a = document.elementsFromPoint(n, r),
                    c = document.elementsFromPoint(o, s),
                    l = [];
                  b[`pointX-${n}-${r}`] || (b[`pointX-${n}-${r}`] = []),
                    Yt && O(n, r);
                  for (let e = 0; e < a.length; e++)
                    if ((l.push(w(a[e])), E(a[e]))) {
                      t = !1;
                      break;
                    }
      ...
      x.config["resource-time"] &&
        ...
        c(i, "load", function () {
          ...
          try {
            ...
            e.destroy(), console.warn("bili-mirror:resource-watch error", t);
          }
        });
    }
  }
  ...
  const sn = s(),
    ...
    fn = (e, t) => {
      r() && At({ type: "pv", eventId: "0.0", msg: e, otherSpmId: t || null });
    },
    hn = (e) => {
      r() &&
        h(e.key) &&
  ...
  function vn(e) {
    r() &&
      (sn.isInited ||
        ((sn.isInited = !0),
        sn.mirrorInitMode || (sn.mirrorInitMode = je.DEFAULT),
        M(e)
          .then(() =>
            t(this, void 0, void 0, function* () {
              var t;
              ...
              (yield Fe.before(Ne.INIT, e)) &&
                ((null === (t = null == e ? void 0 : e.config) || void 0 === t
                  ? void 0
                  : t.isMonitorMethod) &&
                  (null == nn || nn.init(), null == nn || nn.startCheck()),
                tn(null == e ? void 0 : e.config),
                ft(),
                Fe.after(Ne.INIT, e),
                console.info(
                  "%c%s",
  ...
  if (
    r() &&
    (En("__INITIAL_MIRROR__", vn),
    En("__MIRROR_REPORT__", {
      techReportPb: un,
      customReportPb: ln,
      pbReportPv: fn,
      changePbOptions: dn,
      canBatchTechReport: yn,
      customPerformanceQuota: bn,
      exclusiveBisReport: hn,
      changeMirrorModule: cn,
      mirrorTechPvReport: wn,
      trackLogReport: pn,
      trackCustomLog: mn,
      trackGetLog: gn,
    }),
    window[an] && f.isObject(window[an]))
  ) {
    const e = window[an];
    (null === (on = e.config) || void 0 === on ? void 0 : on.isAutoInit) &&
      (!sn.mirrorInitMode && (sn.mirrorInitMode = je.AUTO), vn(e));
  }
  var Rn = {
    SDK_NAME: S,
    SDK_VERSION: _,
  ...
  (e.canBatchTechReport = yn),
    (e.changeMirrorModule = cn),
    (e.changePbOptions = dn),
    (e.customPerformanceQuota = bn),
    (e.customReport = ln),
    (e.customReportPb = ln),
    (e.default = Rn),
    (e.exclusiveBisReport = hn),
    (e.mirrorTechPvReport = wn),
    (e.pbReportPv = fn),
    (e.techReportPb = un),
    (e.trackCustomLog = mn),
    (e.trackGetLog = gn),
