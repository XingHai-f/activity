!(function (e, t) {
  ...
  function i() {
    ...
    return (
      (g.prototype = y),
      o(F, "constructor", { value: y, configurable: !0 }),
  ...
  function B(e) {
    ...
    for (var t = 0, i = e._deferreds.length; t < i; t++) x(e, e._deferreds[t]);
    e._deferreds = null;
  }
  function E(e, t, i) {
  ...
  var K = Y.exports,
    ...
    fe = (function () {
      var e = a(
        i().mark(function e(t, r) {
          var n, o, a, s, l, u, c, d, f, p, v, h, w, b;
          return i().wrap(
            function (e) {
              for (;;)
                switch ((e.prev = e.next)) {
                  case 0:
                    return (
                      ...
                      (l = "function" == typeof navigator.sendBeacon),
                      (u = s
                        ? function () {
                            return ce(a);
                          }
                  ...
                  case 12:
                    if (
                      ((e.prev = 12),
                      (e.t0 = e.catch(6)),
                      !(c = J(le, null == r ? void 0 : r.retry)).enabled)
                    ) {
                      e.next = 29;
                      break;
                    }
                  ...
                  case 19:
                    ...
                    return e.delegateYield(w(), "t1", 21);
                  case 21:
                    if (!(b = e.t1)) {
                      e.next = 24;
                      break;
                  ...
                  case 26:
                    ...
                    break;
                  case 29:
                    console.error("[reporter-pb]: request error", e.t0, a.body);
                  case 30:
                  case "end":
                    return e.stop();
                }
    ...
    be = 4294967296,
    me = 1 / be,
    ge = "undefined" == typeof TextDecoder ? null : new TextDecoder("utf-8"),
    ye = (function () {
      return u(
        function e() {
          var t =
          ...
          },
          {
            ...
            value: function () {
              var e =
                ...
                this.dataView.getUint32(this.pos + 4, !0) * be;
              return (this.pos += 8), e;
            },
          },
          {
            ...
            value: function () {
              var e =
                this.dataView.getUint32(this.pos, !0) +
                this.dataView.getInt32(this.pos + 4, !0) * be;
              return (this.pos += 8), e;
            },
          },
          {
          ...
          },
          {
            ...
            value: function () {
              ...
              return (
                (this.pos = e),
                e - t >= 12 && ge
                  ? ge.decode(this.buf.subarray(t, e))
                  : (function (e, t, i) {
                      var r = "",
                        n = t;
                      for (; n < i; ) {
          ...
          },
          {
            ...
            value: function (e) {
              this.realloc(8),
                ...
                this.dataView.setInt32(this.pos + 4, Math.floor(e * me), !0),
                (this.pos += 8);
            },
          },
          {
  ...
  function Oe(e, t) {
    if (
      ...
      for (var i = 0, r = Object.keys(e.meta); i < r.length; i++) {
        var n = r[i];
        t.writeMessage(4, Me, { key: n, value: e.meta[n] });
      }
  }
  function Me(e, t) {
  ...
  function qe(e, t) {
    if (
      ...
      for (var i = 0, r = Object.keys(e.extra); i < r.length; i++) {
        var n = r[i];
        t.writeMessage(4, Re, { key: n, value: e.extra[n] });
      }
  }
  function Re(e, t) {
    e.key && t.writeStringField(1, e.key),
  ...
  function Le(e, t) {
    if (
      ...
      for (var i = 0, r = Object.keys(e.extra); i < r.length; i++) {
        var n = r[i];
        t.writeMessage(4, Je, { key: n, value: e.extra[n] });
      }
  }
  function Je(e, t) {
    e.key && t.writeStringField(1, e.key),
  ...
  function De(e, t) {
    if (
      ...
      for (var i = 0, r = Object.keys(e.extra); i < r.length; i++) {
        var n = r[i];
        t.writeMessage(6, Ue, { key: n, value: e.extra[n] });
      }
  }
  function Ue(e, t) {
    e.key && t.writeStringField(1, e.key),
  ...
  function ze(e, t) {
    if (e.extra)
      for (var i = 0, r = Object.keys(e.extra); i < r.length; i++) {
        var n = r[i];
        t.writeMessage(1, We, { key: n, value: e.extra[n] });
      }
  }
  function We(e, t) {
    e.key && t.writeStringField(1, e.key),
  ...
  function Ge(e, t) {
    if (
      ...
      for (var i = 0, r = Object.keys(e.player_extra); i < r.length; i++) {
        var n = r[i];
        t.writeMessage(28, He, { key: n, value: e.player_extra[n] });
      }
  }
  function He(e, t) {
    e.key && t.writeStringField(1, e.key),
  ...
  var Qe = { pv: 0, pv_unload: 5, click: 1, custom: 3, player: 4, exposure: 2 },
    Ze = function (e, i) {
      var r,
        n,
        o,
      ...
      !(function (e, t) {
        if (
          (e.info && t.writeMessage(1, Ne, e.info),
          e.runtime_info && t.writeMessage(2, Ae, e.runtime_info),
          ...
          e.page_view_info && t.writeMessage(10, Le, e.page_view_info),
          e.exposure_info && t.writeMessage(11, ze, e.exposure_info),
          e.click_info && t.writeMessage(12, qe, e.click_info),
          e.player_info && t.writeMessage(13, Ge, e.player_info),
          e.page_view_unload_info &&
            t.writeMessage(14, De, e.page_view_unload_info),
          e.extra)
        )
          for (var i = 0, r = Object.keys(e.extra); i < r.length; i++) {
            var n = r[i];
            t.writeMessage(15, Ce, { key: n, value: e.extra[n] });
          }
      })(p, v);
      var h = v.finish();
      return (
    ...
    Ye = function () {
      var e;
      $e || ($e = null !== (e = window.__BMG_AF__) && void 0 !== e ? e : null);
      return $e;
    },
    Ke = (function () {
      var e = a(
                    ...
                    function (t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          ...
                          case 2:
                            et("fp"), e.plugins.fp.fpReport(this, r);
                          case 4:
                          case "end":
                            return t.stop();
                        }
  ...
  it &&
    ...
    ["msgCallbacks", "jsbCallbacks"].forEach(function (e) {
      it.BiliJsBridge[e] || (it.BiliJsBridge[e] = {});
    }));
  var rt = it ? navigator.userAgent : null,
    nt = !!it && /BiliApp|BiliComic|hikari/i.test(rt),
    ot = !!it && /wbType\/common/i.test(rt),
    at = !1,
    st = function (e, t, i, r) {
      var n = it.BiliJsBridge.callbacks.findIndex(function (t) {
        return t.callbackId === +e;
      });
      if (n >= 0) {
        var o = it.BiliJsBridge.callbacks[n];
        if (
          ("global.import" === o.method &&
            (it.BiliJsBridge.appSupportApis = []),
        ...
        r &&
          ...
          (it.BiliJsBridge.callbacks.splice(n, 1),
          o.messageWindow &&
  ...
  function lt(e) {
    var i,
      ...
      n = r.biliInject,
      o = r.biliInjectV2;
    n && !n.biliCallbackReceived && (n.biliCallbackReceived = st),
      o &&
    ...
    for (var l in e)
      Object.prototype.hasOwnProperty.call(e, l) &&
        ...
        (s.push({
          method: e.method,
          callback: e[l],
          callbackId: it.BiliJsBridge.selfCallbackId,
          callbackName: l,
          messageWindow: e.messageWindow,
        }),
        (e[l] = ""),
        (e.data[l + "CallbackId"] = it.BiliJsBridge.selfCallbackId++));
    if (
      (s.push({
        method: e.method,
      ...
      (i = it.BiliJsBridge.callbacks).push.apply(i, s),
    ...
    if (
      ...
      if ("global.unregisterChannel" === e.method) {
        var f = e.callback(),
          p = it.BiliJsBridge.callbacks.findIndex(function (t) {
            return t.eventKey === e.data.key && t.callback === f;
          });
        if (p > -1) {
          var v = it.BiliJsBridge.callbacks[p];
          (e.data.callbackId = v.callbackId),
            it.BiliJsBridge.callbacks.splice(p, 1),
            v.messageWindow &&
    ...
    } else /Android/i.test(rt) || /Linux/i.test(rt) ? c(JSON.stringify({ method: e.method, data: Object.assign(e.data, { callbackId: it.BiliJsBridge.selfCallbackId++ }) })) : c({ method: e.method, data: JSON.stringify(Object.assign(e.data, { callbackId: it.BiliJsBridge.selfCallbackId++ })) });
  }
  function ut(e) {
  ...
  function ct() {
    return (
      ...
      (it.biliInject ||
        (it.webkit &&
          it.webkit.messageHandlers &&
          it.webkit.messageHandlers.biliInject))
    );
  }
  function dt() {
    return (
      ...
      (it.biliInjectV2 ||
        (it.webkit &&
          it.webkit.messageHandlers &&
          it.webkit.messageHandlers.biliInjectV2))
    );
  }
  function ft(e) {
    if (
      ("global.import" === e.method && (it.BiliJsBridge.appSupportApis = []),
      ((e = e || {}).data = e.data || {}),
      !e.method)
    )
      throw new Error("no method");
    it.BiliJsBridge.inited
      ? it.BiliJsBridge.newVersion && lt(e)
      : it.BiliJsBridge.noBiliInject || it.BiliJsBridge.sendTasks.push(e);
  }
  function pt(e) {
    return new Promise(function (t, i) {
      it.BiliJsBridge.appSupportApis.length
        ? t(it.BiliJsBridge.appSupportApis.includes(e))
        : ft({
            method: "global.getAllSupport",
            callback: function (r) {
              try {
                r && r.length && (it.BiliJsBridge.appSupportApis = r),
                  t(r.includes(e));
              } catch (e) {
                i(e);
              }
  ...
  function vt(e) {
    it.BiliJsBridge.biliInjectV2
      ? lt(e)
      : it.BiliJsBridge.noBiliInjectV2 || it.BiliJsBridge.sendTasksV2.push(e);
  }
  function ht(e) {
    if (e.data) {
      var i = {};
      ...
      if (i && (i.iframeMessageId || i.iframeCallbackId || i.iframeRemoveId)) {
        var r = i.iframeMessageId,
          n = it.BiliJsBridge.msgCallbacks[r];
        if (n)
          return (
            "function" == typeof n && n(i),
            void delete it.BiliJsBridge.msgCallbacks[i.iframeMessageId]
          );
        if (i.iframeCallbackId) {
          var o = it.BiliJsBridge.jsbCallbacks[i.iframeCallbackId];
          "function" == typeof o && o(i.jsbReceiveArgs);
        } else if (i.iframeRemoveId)
          delete it.BiliJsBridge.jsbCallbacks[i.iframeRemoveId];
        else if (i.method) {
          var a = e.source,
  ...
  it &&
    !it.BiliJsBridge.msgListener &&
    (window.addEventListener("message", ht),
    (it.BiliJsBridge.msgListener = ht));
  var wt = function () {
      return at
        ? Promise.resolve()
        : ((at = !0),
          Promise.all([
            ut(ct)
              .then(function () {
                (it.BiliJsBridge.biliInject = ct()),
                  (it.BiliJsBridge.newVersion = !0),
                  it.BiliJsBridge.sendTasks.forEach(function (e) {
                    return lt(e);
                  }),
                  (it.BiliJsBridge.sendTasks = []);
              })
              .catch(function () {
                it.BiliJsBridge.noBiliInject = !0;
              })
              .finally(function () {
                it.BiliJsBridge.inited = !0;
              }),
            ut(dt)
              .then(function () {
                (it.BiliJsBridge.biliInjectV2 = dt()),
                  it.BiliJsBridge.sendTasksV2.forEach(function (e) {
                    return lt(e);
                  }),
                  (it.BiliJsBridge.sendTasksV2 = []);
              })
              .catch(function () {
                it.BiliJsBridge.noBiliInjectV2 = !0;
              })
              .finally(function () {
                it.BiliJsBridge.initedV2 = !0;
              }),
          ]));
    },
    bt = pt,
    ...
    gt = function (e, t) {
      return new Promise(function (i, r) {
        _t({ method: e, params: t, resolve: i, reject: r }) ||
          vt({
            method: e,
            data: t || {},
            isApiV2: !0,
  ...
  if (it && window !== window.parent && window.top) {
    var yt = function (e, t) {
      (e.method = "bili_jsb_".concat(e.method)),
        (e.iframeMessageId = Math.random()),
        (it.BiliJsBridge.msgCallbacks[e.iframeMessageId] = t || function () {}),
    ...
    (wt = function () {
      ...
      (bt = function (e) {
        return new Promise(function (t) {
          yt({ method: "isSupport", api: e }, function (e) {
            var i = e.support;
            return t(i);
          });
        });
      ...
      (mt = function (e) {
        ...
        yt({ method: "callNative", option: i }, function (t) {
          (t.callbacks || []).forEach(function (t) {
            it.BiliJsBridge.jsbCallbacks[t.callbackId] = e[t.callbackName];
          });
        });
      }),
      (gt = function (e, t) {
          ...
          _t({ method: e, params: t, resolve: i, reject: r }) ||
            yt(
              ...
              function (e) {
                ...
                it.BiliJsBridge.jsbCallbacks[t] = function (e) {
                  e && 0 === e.code ? i(e) : r(e);
                };
              }
            );
            ...
            for (;;)
              switch ((e.prev = e.next)) {
                ...
                case 2:
                  ...
                  return (e.next = 5), Ft();
                case 5:
                  return (e.next = 7), gt("global.getContainerInfo", {});
                case 7:
                  (r = e.sent),
                    (n =
                ...
                case 2:
                  return (
                    "string" == typeof r.type &&
                      (r.type =
                        null !== (o = Et[r.type]) && void 0 !== o ? o : 0),
                    1 !== r.type || xt[r.event] || (xt[r.event] = Bt()),
                    (e.next = 6),
                    kt
                  );
                case 6:
                  return (
                    ...
                    ((r.params && "object" !== n(r.params)
                      ...
                      ? a
                      : {}
                    ).polaris_action_id = xt[r.event]),
                    (s = JSON.stringify(r.params)),
                    e.abrupt(
                      "return",
                      gt("ability.reportEvent", t(t({}, r), {}, { params: s }))
                    )
                  );
                case 11:
                case "end":
  ...
  function jt(e, t) {
    if (
      ...
      for (var i = 0, r = Object.keys(e.meta); i < r.length; i++) {
        var n = r[i];
        t.writeMessage(4, Pt, { key: n, value: e.meta[n] });
      }
  }
  function Pt(e, t) {
    e.key && t.writeStringField(1, e.key),
  ...
  function Ct(e, t) {
    if (
      ...
      for (var i = 0, r = Object.keys(e.extra); i < r.length; i++) {
        var n = r[i];
        t.writeMessage(27, Nt, { key: n, value: e.extra[n] });
      }
  }
  function Nt(e, t) {
    e.key && t.writeStringField(1, e.key),
  ...
  function At(e, t) {
    ...
    if (e.extra)
      for (var o = 0, a = Object.keys(e.extra); o < a.length; o++) {
        var s = a[o];
        t.writeMessage(6, qt, { key: s, value: e.extra[s] });
      }
  }
  function qt(e, t) {
    e.key && t.writeStringField(1, e.key),
  ...
  function Lt(e, t) {
    if (
      ...
      for (var i = 0, r = Object.keys(e.player_extra); i < r.length; i++) {
        var n = r[i];
        t.writeMessage(28, Jt, { key: n, value: e.player_extra[n] });
      }
  }
  function Jt(e, t) {
    e.key && t.writeStringField(1, e.key),
  ...
  var Dt = { performance: 0, error: 1, player: 3, custom: 2 },
    Ut = function (e) {
      var t,
        i =
    ...
    zt = function (e, i) {
      ...
      !(function (e, t) {
        if (
          (e.info && t.writeMessage(1, Ot, e.info),
          e.runtime_info && t.writeMessage(2, Mt, e.runtime_info),
          e.event_id && t.writeStringField(3, e.event_id),
          e.business && t.writeStringField(4, e.business),
          e.sn && t.writeVarintField(5, e.sn),
          e.sn_gen_time && t.writeVarintField(6, e.sn_gen_time),
          ...
          e.upload_time && t.writeVarintField(8, e.upload_time),
          e.event_category && t.writeVarintField(9, e.event_category),
          e.performance_info && t.writeMessage(10, Ct, e.performance_info),
          e.error_event_info && t.writeMessage(11, At, e.error_event_info),
          e.player_info && t.writeMessage(12, Lt, e.player_info),
          e.extra)
        )
          for (var i = 0, r = Object.keys(e.extra); i < r.length; i++) {
            var n = r[i];
            t.writeMessage(13, Tt, { key: n, value: e.extra[n] });
          }
      })(f, p);
      var v = p.finish();
      return (
    ...
    Gt = (function () {
      return u(
        function e(r, n, o) {
          ...
          s(this, e),
            (this.options = r),
            (this.initBuvidPromise = (n || we()).then(function () {
              u.buvidInit = !0;
            })),
  ...
  return tt.use({ native: It, tech: Gt }), tt;
});
