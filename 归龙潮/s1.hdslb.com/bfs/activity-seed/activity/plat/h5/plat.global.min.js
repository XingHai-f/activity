...
!(function () {
  ...
  if (
    !/(\?|\&)showNav\=1(\&|$)/.test(href) ||
    window.navigator.userAgent.indexOf("BiliApp") < 0 ||
    !Object.keys
  ) {
    return false;
  }
  var style = {
    ...
    borderRadius: "50%",
    background:
      "url(data:image/png;base64,) center center / 60% no-repeat rgba(0,0,0,.5)",
    borderRadius: "50%",
    left: ".3rem",
    top: ".6rem",
    position: "fixed",
  ...
  var template = '<a class="act-nav-back"></a>';
  var nav = document.createElement("div");
  nav.innerHTML = template;
  var $back = nav.querySelector(".act-nav-back");
  addStyle($back, style);
...
var whiteHrefListReg = /is_live_half_webview/gi;
var actUa = window.navigator.userAgent.toLowerCase();

function detectSpecLink(str, hasQuery) {
  if (str.indexOf("video/av") > -1) {
    sobj.from_spmid = "activity.activity-detail.activity-h5.0";
    return (
      (hasQuery ? "&" : "?") +
      "from_spmid=activity.activity-detail.activity-h5.0"
    );
  }
  return "";
}
...
function parseHref(str) {
  ...
  if (/(https?:)?\/\//.test(_s)) {
    newUrl = new URL(
      str.replace(/(https?:)?(\/\/)(.+)/gi, location.protocol + "$2$3")
    );
    isURL = true;
    if (newUrl.hash) {
      _s = newUrl.origin + newUrl.pathname + newUrl.search;
    }
  }

  var u = _s.indexOf("?") > -1;
  var search = window.location.search;
  var linkParam = detectSpecLink(str, u || search);

  var sourcekeys = Object.keys(sobj);
  for (var _i = 0; _i < sourcekeys.length; _i++) {
    var _key = sourcekeys[_i];
    if (_s.indexOf(_key + "=") > -1) {
      delete sobj[_key];
    }
    if (
      ["from", "msource"].indexOf(_key) === -1 &&
      location.host.indexOf("mall") > -1
    ) {
      delete sobj[_key];
    }
  }

  // if (_s.indexOf('from=') > -1) {
  //   delete sobj.from;
  // }

  // 直播的跳转移除 is_live_webview=1
  search = search.replace(/is_live_webview=1/gi, "");

  var queryString = Object.keys(sobj)
    .map(function (key) {
      return key + "=" + sobj[key];
    })
    .join("&");
...
function customReporter(key, value) {
  try {
    reportMsgObj[key + value] = 1;
...
window.addEventListener("load", function () {
  ...
  if (sobj.msource) {
    customReporter("msource_", sobj.msource);
  }

  if (sobj.topic_from) {
    customReporter("topic_from_", sobj.topic_from);
  }

  if (actUa.indexOf("biliapp") > -1) {
    customReporter("from_bili_app", "");
  }

  var all = document.querySelectorAll("div a");
  for (var i = 0, len = all.length; i < len; i++) {
    if (all[i].dataset.link) {
...
!(function () {
  ...
  var biliMatch = ua.match(/BiliApp\/(\d+)/);
  var mobiMatch = ua.match(/mobi_app\/(\w+)/);
  if (
    biliMatch &&
    biliMatch.length >= 2 &&
    mobiMatch &&
    ...
    var plat = mobiMatch[1];
    var version = biliMatch[1];
    ajaxGet(
      "https://api.bilibili.com/x/activity/iir?mobi_app=" +
        plat +
        "&build=" +
        version,
      function (res) {
        ...
        if (res.data.iir === true) {
          renderFixedButton();
        }
      }
    );
  }
  function ajaxGet(url, succCb, failCb) {
  ...
  function renderFixedButton() {
    ...
    div.innerHTML =
      '<a href="https://www.' +
      "bilibili" +
      '.com/blackboard/activity-0mn9gdjW.html" target="_blank">查看活动声明</a>';
    var style = {
...
// fix new comment style
var cs = document.createElement("style");
cs.innerText = `.reply-list { margin-bottom: 0 !important; }`;
  ...
  !(function (r) {
          ...
          (t.exports = function (t, l, n, o) {
            ...
            !p || !S.ABV
              ? ((p = n(function (t, n, r, e) {
                  ...
                  for (
                    x(t, "_d", { b: i, o: a, l: o, e: u, v: new Z(i) });
                    f < u;
              ...
              : (_(function () {
                ...
                Q(
                  e !== Function.prototype ? I(c).concat(I(e)) : I(c),
                  function (t) {
                    t in p || x(p, t, c[t]);
                  }
                ),
      ...
      t.exports = function (t, n, r, e, i, o, u) {
        ...
        if (
          (_ &&
            ...
            a.next &&
            (O(a, l, !0), b || "function" == typeof a[M] || x(a, M, A)),
          h &&
            g &&
            g.name !== I &&
            ((p = !0),
    ...
    function (t, n, r) {
      ...
      s(function () {
        ...
        (c((o = f.getConstructor(d, h)).prototype, _),
        (i.NEED = !0),
    ...
    function (t, n, r) {
      ...
      V ||
        ...
        (r(48).f = X),
        (r(52).f = Q),
        i && !r(33) && c(G, "propertyIsEnumerable", X, !0),
        (v.f = function (t) {
          return K(p(t));
        })),
          ...
          u = function (t, n) {
            ...
            for (
              ...
              !(
                ...
                1 < i[y] && i.index < r[y] && g.apply(f, i.slice(1)),
                (u = i[0][y]),
                (s = o),
                l <= f[y])
              );
