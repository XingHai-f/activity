/*! For license information please see core.9eddca23536a791581ae.min.js.LICENSE.txt */
!(function () {
  var t = {
      282: function (t, e, r) {
        "use strict";
        ...
        var u,
          ...
          s = l.ERR_INVALID_ARG_TYPE,
          y = l.ERR_INVALID_ARG_VALUE,
          g = l.ERR_INVALID_RETURN_VALUE,
          b = l.ERR_MISSING_ARGS,
          h = r(961),
          d = r(539).inspect,
          v = r(539).types,
          m = v.isPromise,
        ...
        function A() {
          var t = r(158);
          (u = t.isDeepEqual), (f = t.isDeepStrictEqual);
        }
        var E = !1,
          x = (t.exports = T),
          P = {};
        ...
        function T() {
          for (var t = arguments.length, e = new Array(t), r = 0; r < t; r++)
            e[r] = arguments[r];
          R.apply(void 0, [T, e.length].concat(e));
        }
        (x.fail = function t(e, r, i, c, a) {
          var u,
            f = arguments.length;
          if (0 === f) u = "Failed";
        ...
        function _(t) {
          return Promise.resolve().then(function () {
            ...
            if ("function" == typeof t) {
              ...
              if (!M(t)) throw new s("promiseFn", ["Function", "Promise"], t);
              e = t;
            }
        ...
        function B(t, e, r, n) {
          if (e !== P) {
            if (
              ("string" == typeof r && ((n = r), (r = void 0)), !r || F(e, r))
            ) {
              var o = n ? ": ".concat(n) : ".",
        ...
        function D(t, e, r, n, o) {
          if (!w(e)) throw new s("regexp", "RegExp", e);
          var c = "match" === o;
          if ("string" != typeof t || S(e, t) !== c) {
        ...
        function q() {
          for (var t = arguments.length, e = new Array(t), r = 0; r < t; r++)
            e[r] = arguments[r];
          R.apply(void 0, [q, e.length].concat(e));
        }
      ...
      961: function (t, e, r) {
        ...
        function P(t, e, r) {
          ...
          for (
            var b = l[l.length - 1], d = p[p.length - 1];
            b === d &&
            (s++ < 2 ? (a = "\n  ".concat(b).concat(a)) : (o = b),
            l.pop(),
            p.pop(),
            0 !== l.length && 0 !== p.length);

          )
            (b = l[l.length - 1]), (d = p[p.length - 1]);
          var v = Math.max(l.length, p.length);
          if (0 === v) {
            var E = f.split("\n");
            if (E.length > 30)
              for (E[26] = "".concat(w, "...").concat(S); E.length > 27; )
                E.pop();
            return "".concat(A.notIdentical, "\n\n").concat(E.join("\n"), "\n");
          }
          s > 3 && ((a = "\n".concat(w, "...").concat(S).concat(a)), (u = !0)),
            "" !== o && ((a = "\n  ".concat(o).concat(a)), (o = ""));
          var P = 0,
            k =
              A[r] +
              "\n"
                ...
                .concat(O, "- expected")
                .concat(S),
            R = " ".concat(w, "...").concat(S, " Lines skipped");
          for (s = 0; s < v; s++) {
            var T = s - c;
            if (l.length < s + 1)
              T > 1 &&
                ...
                P++),
                (c = s),
                (o += "\n".concat(O, "-").concat(S, " ").concat(p[s])),
                P++;
            else if (p.length < s + 1)
              T > 1 &&
                s > 2 &&
                (T > 4
                  ? ((i += "\n".concat(w, "...").concat(S)), (u = !0))
                ...
                P++),
                (c = s),
                (i += "\n".concat(j, "+").concat(S, " ").concat(l[s])),
                P++;
            else {
              var I = p[s],
                F = l[s],
                N = F !== I && (!m(F, ",") || F.slice(0, -1) !== I);
              N && m(I, ",") && I.slice(0, -1) === F && ((N = !1), (F += ",")),
                N
                  ? (T > 1 &&
                      s > 2 &&
                      (T > 4
                      ...
                      P++),
                    (c = s),
                    (i += "\n".concat(j, "+").concat(S, " ").concat(F)),
                    (o += "\n".concat(O, "-").concat(S, " ").concat(I)),
                    (P += 2))
                  : ((i += o),
                    (o = ""),
                    (1 !== T && 0 !== s) || ((i += "\n  ".concat(F)), P++));
        ...
        var k = (function (t, e) {
          ...
          function m(t) {
            ...
            if (((Error.stackTraceLimit = 0), null != r))
              ...
              e =
                1 === y.length
                  ? s.call(this, "".concat(p, " ").concat(y[0]))
                  : s.call(
                      this,
                      "".concat(p, "\n\n").concat(y.join("\n"), "\n")
                    );
                ...
                : ((b = "".concat(x(a))),
                  ...
                  "deepEqual" === o || "equal" === o
                    ? (g = ""
                        ...
                        .concat(g, "\n\nshould equal\n\n"))
                    : (b = " ".concat(o, " ").concat(b))),
                (e = s.call(this, "".concat(g).concat(b)));
            }
            return (
              ...
              (e.expected = a),
              (e.operator = o),
              Error.captureStackTrace && Error.captureStackTrace(l(e), i),
              e.stack,
          ...
          p(
            ...
            function (t, e, o) {
              ...
              if (
                ...
                "string" == typeof e &&
                ((c = "not "), e.substr(!a || a < 0 ? 0 : +a, c.length) === c)
                ...
                f = "The ".concat(t, " ").concat(i, " ").concat(s(e, "type"));
              else {
      ...
      158: function (t, e, r) {
        ...
        var c = void 0 !== /a/g.flags,
          ...
          f = Object.is ? Object.is : r(609),
          l = Object.getOwnPropertySymbols
            ? Object.getOwnPropertySymbols
            : function () {
                return [];
              },
          p = Number.isNaN ? Number.isNaN : r(360);
        function s(t) {
          return t.call.bind(t);
        }
        var y = s(Object.prototype.hasOwnProperty),
          g = s(Object.prototype.propertyIsEnumerable),
        ...
        function q(t, e, r, n) {
          ...
          if (r) {
            if ("object" !== i(t)) return "number" == typeof t && p(t) && p(e);
          ...
          if (Array.isArray(t)) {
            ...
            var y = N(t),
              g = N(e);
            return y.length === g.length && G(t, e, r, n, U, y);
          }
          if ("[object Object]" === s && ((!w(t) && w(e)) || (!O(t) && O(e))))
            return !1;
          if (m(t)) {
            if (
              !m(e) ||
            ...
            if (v(t)) {
              ...
              var h = N(t),
                F = N(e);
              return h.length === F.length && G(t, e, r, n, _, h);
            }
            if (O(t)) return !(!O(e) || t.size !== e.size) && G(t, e, r, n, B);
            if (w(t)) return !(!w(e) || t.size !== e.size) && G(t, e, r, n, D);
            if (d(t)) {
              if (
                ((a = e),
                (o = t).byteLength !== a.byteLength ||
                  0 !== M(new Uint8Array(o), new Uint8Array(a)))
              )
                return !1;
            } else if (
              A(t) &&
        ...
        function G(t, e, r, o, c, f) {
          if (5 === arguments.length) {
            f = Object.keys(t);
            var p = Object.keys(e);
            if (f.length !== p.length) return !1;
          }
          for (var s = 0; s < f.length; s++) if (!y(e, f[s])) return !1;
          if (r && 5 === arguments.length) {
            ...
            if (0 !== b.length) {
              ...
              var v = l(e);
              if (b.length !== v.length && $(e, v).length !== h) return !1;
            } else {
              var m = l(e);
              if (0 !== m.length && 0 !== $(e, m).length) return !1;
            }
          }
          if (
            0 === f.length &&
            (c === _ || (c === U && 0 === t.length) || 0 === t.size)
          )
            return !0;
          if (void 0 === o)
            ...
            if (f === B) {
              if (
                !(function (t, e, r, n) {
                  ...
                  if (null !== o) {
                    for (var l = a(e), p = 0; p < l.length; p++) {
                      var s = l[p];
                      if ("object" === i(s) && null !== s) {
                        if (!L(o, s, r, n)) return !1;
                      } else if (!r && !t.has(s) && !L(o, s, r, n)) return !1;
                    }
                    return 0 === o.size;
                  }
                  return !0;
                ...
                !(function (t, e, r, o) {
                  for (var c = null, a = u(t), f = 0; f < a.length; f++) {
                    ...
                    if ("object" === i(p) && null !== p)
                      null === c && (c = new Set()), c.add(p);
                    else {
                      var y = e.get(p);
                      if ((void 0 === y && !e.has(p)) || !q(s, y, r, o)) {
                        if (r) return !1;
                        if (!C(t, e, p, s, o)) return !1;
                        null === c && (c = new Set()), c.add(p);
                      }
                    }
                  }
                  if (null !== c) {
                    for (var g = u(e), b = 0; b < g.length; b++) {
                      ...
                      if ("object" === i(d) && null !== d) {
                        if (!V(c, t, d, v, r, o)) return !1;
                      } else if (
                        !(
                          r ||
                          (t.has(d) && q(t.get(d), v, !1, o)) ||
                          V(c, t, d, v, !1, o)
                        )
                      )
                        return !1;
              ...
              for (; l < t.length; l++) {
                if (!y(t, l)) {
                  if (y(e, l)) return !1;
                  for (var p = Object.keys(t); l < p.length; l++) {
                    var s = p[l];
                    if (!y(e, s) || !q(t[s], e[s], r, c)) return !1;
                  }
                  return p.length === Object.keys(e).length;
                }
                if (!y(e, l) || !q(t[l], e[l], r, c)) return !1;
              }
            for (l = 0; l < o.length; l++) {
              var g = o[l];
              if (!q(t[g], e[g], r, c)) return !1;
            }
            return !0;
          })(t, e, r, f, o, c);
        ...
        function L(t, e, r, n) {
          for (var o = a(t), i = 0; i < o.length; i++) {
            var c = o[i];
            if (q(e, c, r, n)) return t.delete(c), !0;
          }
          return !1;
        }
        function z(t) {
        ...
        function V(t, e, r, n, o, i) {
          for (var c = a(t), u = 0; u < c.length; u++) {
            var f = c[u];
            if (q(r, f, o, i) && q(n, e.get(f), o, i)) return t.delete(f), !0;
          }
          return !1;
        }
        t.exports = {
      ...
      559: function (t, e, r) {
        ...
        t.exports = function (t) {
          if ("function" != typeof t) throw new c("a function is required");
          ...
          if (
            ((i = Function(
              ...
              if (this instanceof i) {
                var e = o.apply(this, n(c, arguments));
                return Object(e) === e ? e : this;
              }
              return o.apply(t, n(c, arguments));
            })),
            o.prototype)
          ) {
            var l = function () {};
      ...
      210: function (t, e, r) {
        ...
        var f = function () {
          ...
          y =
            ...
            (s
              ...
              : null),
          g = {},
          b = "undefined" != typeof Uint8Array && y ? y(Uint8Array) : n,
          h = {
            "%AggregateError%":
        ...
        var v = function t(e) {
          ...
          R = function (t, e) {
            var r,
              n = t;
            if ((j(m, n) && (n = "%" + (r = m[n])[0] + "%"), j(h, n))) {
              var i = h[n];
              if ((i === g && (i = v(n)), void 0 === i && !e))
                throw new c(
                  "intrinsic " +
                    t +
      ...
      987: function (t, e, r) {
        ...
        if (!Object.keys) {
          ...
          n = function (t) {
            ...
            if (n && t.length > 0)
              for (var h = 0; h < t.length; ++h) s.push(String(h));
            else
              for (var d in t)
                (g && "prototype" === d) || !o.call(t, d) || s.push(String(d));
            if (u)
              for (
                var v = (function (t) {
      ...
      837: function (t, e, r) {
        ...
        t.exports = function (t, e) {
          ...
          for (var i = 1; i < arguments.length; ++i) {
            ...
            if (s)
              for (var y = s(l), g = 0; g < y.length; ++g) {
                var b = y[g];
                u(l, b) && a(p, b);
              }
      ...
      155: function (t) {
        ...
        (n.nextTick = function (t) {
          ...
          u.push(new y(t, e)), 1 !== u.length || f || c(s);
        }),
      ...
      955: function (t, e, r) {
        ...
        (e.isArgumentsObject = n),
          ...
          (e.isMap = function (t) {
            return (
              "undefined" != typeof Map && (d.working ? d(t) : t instanceof Map)
            );
          }),
      ...
      539: function (t, e, r) {
        ...
        function b(t, e, r, n, o, i) {
          ...
          if (
            ...
            (c = JSON.stringify("" + o)).match(/^"([a-zA-Z_][a-zA-Z_0-9]*)"$/)
              ? ((c = c.slice(1, -1)), (c = t.stylize(c, "name")))
              : ((c = c
                  .replace(/'/g, "\\'")
                  .replace(/\\"/g, '"')
                  .replace(/(^"|"$)/g, "'")),
        ...
        (e.log = function () {
          ...
          o.log(
            "%s - %s",
            ((t = new Date()),
            (r = [k(t.getHours()), k(t.getMinutes()), k(t.getSeconds())].join(
              ":"
            )),
            [t.getDate(), R[t.getMonth()], r].join(" ")),
  ...
  !(function () {
    ...
    var e = (function () {
      ...
      return (
        ...
        (e.prototype.on = function (t, e) {
          if (!t || !e) return !1;
          this.eventMap[t] || (this.eventMap[t] = []),
            this.eventMap[t].push({ type: t, handler: e });
        }),
        (e.prototype.off = function (t, e) {
          var r = this.eventMap[t];
          if (!Array.isArray(r)) return !1;
          e || delete this.eventMap[t];
          var n = r.findIndex(function (t) {
            return e === t.handler;
          });
          n > -1 && r.splice(n, 1);
        }),
        (e.prototype.emit = function (e, r, n) {
          ...
          o.forEach(function (t, e) {
            ...
            !(n = c) ||
              ...
              i.push(c),
              t.options && t.options.once && o.splice(e, 1);
          }),
            Promise.all(i)
              .then(function () {
                return n ? n() : null;
    ...
    window.BiliActEvents || (window.BiliActEvents = new e()),
